...
<div class="main-header">
    ...
    <p>Tác giả: Mã Kỹ Sư - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 097 6984 628</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Mã Kỹ Sư - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 097 6984 628</div>", unsafe_allow_html=True)
